...
public class TripManagerTest {
    ...
    public void createTrip() throws Exception {
        ...
        tripManager.createTrip(BoatTripType.RIVER_TRIP);
    ...
    public void endExistingTripTest() {
        ...
        BoatTrip trip = t.createTrip(BoatTripType.RIVER_TRIP);
    ...
    public void tripsTestAverageTime() throws InterruptedException {
        ...
        a1.createTrip(BoatTripType.RIVER_TRIP);
        a1.createTrip(BoatTripType.RIVER_TRIP);
        a1.endTrip(1);
        a1.endTrip(2);
    ...
    public void endTripPriceCalculator26rain() {
        ...
        BoatTrip trip = new BoatTrip(now, 1, BoatTripType.RIVER_TRIP);
